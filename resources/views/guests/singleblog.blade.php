...
<section class="page-header position-relative overflow-hidden ptb-120 bg-dark" style="background: url('{{ asset("blogimages/".$blog->banner) }}')no-repeat bottom left">
    <div class="container">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-4">
                <div class="author-wrap text-center bg-light p-5 sticky-sidebar rounded-custom mt-5 mt-lg-0">
                    <img src="#" alt="author" width="120" class="img-fluid shadow-sm rounded-circle">
