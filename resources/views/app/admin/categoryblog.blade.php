...
@section('tittletop', 'Blog Category')
@section('tittle', 'Blog Category')
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bold text-hover-primary fs-6">{{ $category->category }}</a>
                            </td>
                            <td>
                                <a href="#" class="text-dark fw-bold text-hover-primary d-block fs-6">{{ $category->slug }}</a>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <form method="post" action="{{route('blogcat.destroy', $category->id)}}">
                                        @method('delete')
                                        @csrf
											...
											<div class="rounded border p-10">
												<div class="mb-10">
                                                    <form action="{{ route('blogcat.store') }}" method="POST">
                                                        @csrf
													<label for="exampleFormControlInput1" class="required form-label">Create a new Blog Category</label>
