    ...
    <div class="card card-xxl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Acarty Users</span>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        ...
                                        <span class="text-muted fw-semibold text-muted d-block fs-7">@if(!empty($user->getRoleNames()))
                            ...
                            <td>
                                ...
                                <span class="text-muted fw-semibold text-muted d-block fs-7">Mobile number</span>
                            </td>
                            <td class="text-end">
