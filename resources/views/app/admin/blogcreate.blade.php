...
@section('tittletop', 'Create A Blogs')
...
@section('footer')
<script src="{{ asset('app/plugins/file-upload/file-upload-with-preview.min.js') }}"></script>
...
<div id="flHorizontalForm" class="col-lg-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            <form method="POST" action="{{ route('blogs.store') }}" id="kt_account_profile_details_form" class="form" enctype="multipart/form-data">
            @csrf
                <div class="form-group row mb-4">
                    <label for="" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Title</label>
                    <div class="col-xl-10 col-lg-9 col-sm-10">
                        <input type="text"  name="title" class="form-control" id="" placeholder="" value="{{ old('title') }}">
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-xl-10 col-lg-9 col-sm-10">
                        <textarea name="content" rows="10" class="form-control ckeditor" aria-label="With textarea">{{ old('content') }}</textarea>
                    </div>
                </div>
